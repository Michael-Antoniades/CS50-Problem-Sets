        ...
        if (numdigits > 16 or numdigits < 13 or numdigits == 14):
            ...
            for i in range(0, ccn!=0 , 1):          #lines 20-29 are my problem, they are behaving differently than C does, some cases work others don't 
                ...
                if math.remainder(i,2) == 0:
                    ...
                    print(sumation)
                    print(ccn)
                elif math.remainder(i,2) != 0: #lines 25-29 are now the case I have to look out for
                    seperator = 2 *  ccn%10 #(math.remainder(ccn,10));
                    
                    sumation += seperator / 10 + seperator%10  #(math.remainder(seperator,10));
                    print(sumation);
                    print(ccn)
                    print(seperator)
